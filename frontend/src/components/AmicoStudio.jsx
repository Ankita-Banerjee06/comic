...
export default function AmicoStudio() {
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-800 rounded-xl shadow-2xl max-w-4xl mx-auto my-8 border border-gray-700 transition-all duration-300 hover:shadow-fuchsia-500/20">
      <h2 className="text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-purple-600 mb-6">AMICO - Comic Studio</h2>
